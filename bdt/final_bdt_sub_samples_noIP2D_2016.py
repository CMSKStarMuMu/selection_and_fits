...
sig_list = [
          'sub_samples/sample_2016_MC_LMNR_0_add_vars_passPreselection.root', 
          'sub_samples/sample_2016_MC_LMNR_1_add_vars_passPreselection.root',
          'sub_samples/sample_2016_MC_LMNR_2_add_vars_passPreselection.root', 
          'sub_samples/sample_2016_MC_LMNR_3_add_vars_passPreselection.root', 
          'sub_samples/sample_2016_MC_LMNR_4_add_vars_passPreselection.root', 
          'sub_samples/sample_2016_MC_LMNR_5_add_vars_passPreselection.root', 
          'sub_samples/sample_2016_MC_LMNR_6_add_vars_passPreselection.root', 
          'sub_samples/sample_2016_MC_LMNR_7_add_vars_passPreselection.root', 
          'sub_samples/sample_2016_MC_LMNR_8_add_vars_passPreselection.root', 
          'sub_samples/sample_2016_MC_LMNR_9_add_vars_passPreselection.root', 
          'sub_samples/sample_2016_MC_LMNR_10_add_vars_passPreselection.root',
]

bkg_list = [
          'sub_samples/sample_2016_data_LMNR_0_add_vars.root',
          'sub_samples/sample_2016_data_LMNR_1_add_vars.root',
          'sub_samples/sample_2016_data_LMNR_2_add_vars.root',
          'sub_samples/sample_2016_data_LMNR_3_add_vars.root',
          'sub_samples/sample_2016_data_LMNR_4_add_vars.root',
          'sub_samples/sample_2016_data_LMNR_5_add_vars.root',
          'sub_samples/sample_2016_data_LMNR_6_add_vars.root',
          'sub_samples/sample_2016_data_LMNR_7_add_vars.root',
          'sub_samples/sample_2016_data_LMNR_8_add_vars.root',
          'sub_samples/sample_2016_data_LMNR_9_add_vars.root',
          'sub_samples/sample_2016_data_LMNR_10_add_vars.root',
]

import pdb
for isample in range(0,11):

#     tag = '_useMinMaxIP_2016_%s'%isample
#     tag = '_useMaxIso_2016_%s'%isample
    tag = '_noIP2D_2016_%s'%isample
#     tag = '_noIP2D_2016_noTrkSign_%s'%isample
#     tag = '_removekstMass_2016_%s'%isample
#     tag = '_deltakstMass_2016_%s'%isample
...
#     plt.savefig('mass_sig_onesample.pdf')
    ...
    ## no IP2D, yes TRk SIGN
    # {'target': 1440.996911154948, 'params': {'colsample_bytree': 0.8840463795346134, 'learning_rate': 0.08412472689370357, 
    # 'max_depth': 3.6099470130706504, 'min_child_weight': 3.9676072658193573, 'n_estimators': 598.9489751855428, 'subsample': 0.6735908686137309}}
    
    ## no IP2D, NO TRk SIGN
    # {'target': 1416.5189214399338, 'params': {'colsample_bytree': 0.7856752702897066, 'learning_rate': 0.06783170969494529, 
    # 'max_depth': 4.000833743460668, 'min_child_weight': 5.326045881788436, 'n_estimators': 633.0760065802482, 'subsample': 0.7604123294718493}}

    clf = XGBClassifier(
        colsample_bytree = 0.8840,
        learning_rate    = 0.0841,
        min_child_weight = 3.9676,
        n_estimators     = 600,
        max_depth        = int(round(3.6)),
        subsample        = 0.6736,
        seed             = 1986,
        silent           = False,
