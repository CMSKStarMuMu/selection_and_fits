...
def xgboost_fom(
    ...
    clf = XGBClassifier(
        max_depth        = int(round(max_depth)), #3, #int(round(max_depth)),
        learning_rate    = learning_rate,
        n_estimators     = int(round(n_estimators)),
        min_child_weight = min_child_weight, #2.180982430013085, #min_child_weight,
        subsample        = subsample,
...
#     for wp in np.arange(0.9,1,0.005):
...
sig_list = [
          'sub_samples/sample_2018_MC_LMNR_0_add_vars_passPreselection.root:ntuple',  ### need to include PU profile
          'sub_samples/sample_2018_MC_LMNR_2_add_vars_passPreselection.root:ntuple',  ### need to include PU profile
          'sub_samples/sample_2018_MC_LMNR_3_add_vars_passPreselection.root:ntuple',  ### need to include PU profile
          'sub_samples/sample_2018_MC_LMNR_4_add_vars_passPreselection.root:ntuple',  ### need to include PU profile
          'sub_samples/sample_2018_MC_LMNR_5_add_vars_passPreselection.root:ntuple',  ### need to include PU profile
          'sub_samples/sample_2018_MC_LMNR_6_add_vars_passPreselection.root:ntuple',  ### need to include PU profile
          'sub_samples/sample_2018_MC_LMNR_7_add_vars_passPreselection.root:ntuple',  ### need to include PU profile
          'sub_samples/sample_2018_MC_LMNR_8_add_vars_passPreselection.root:ntuple',  ### need to include PU profile
          'sub_samples/sample_2018_MC_LMNR_9_add_vars_passPreselection.root:ntuple',  ### need to include PU profile
          'sub_samples/sample_2018_MC_LMNR_10_add_vars_passPreselection.root:ntuple', ### need to include PU profile
]

bkg_list = [
          'sub_samples/sample_2018_data_LMNR_0_add_vars.root:ntuple',
          'sub_samples/sample_2018_data_LMNR_2_add_vars.root:ntuple',
          'sub_samples/sample_2018_data_LMNR_3_add_vars.root:ntuple',
          'sub_samples/sample_2018_data_LMNR_4_add_vars.root:ntuple',
          'sub_samples/sample_2018_data_LMNR_5_add_vars.root:ntuple',
          'sub_samples/sample_2018_data_LMNR_6_add_vars.root:ntuple',
          'sub_samples/sample_2018_data_LMNR_7_add_vars.root:ntuple',
          'sub_samples/sample_2018_data_LMNR_8_add_vars.root:ntuple',
          'sub_samples/sample_2018_data_LMNR_9_add_vars.root:ntuple',
          'sub_samples/sample_2018_data_LMNR_10_add_vars.root:ntuple',
]
...
logger = JSONLogger(path="logs_punzi_2018_fixBkg_noIP2D_6pars.json")
...
for i, ipar in enumerate(optimizer.space.keys):  
  ...
  plt.legend()
  plt.savefig('test_%s_bounds_6pars_2018_fixBkg_noIP2D_6pars.pdf'%ipar)
  plt.clf()
