...
sig_list = [
          'sub_samples/sample_2018_MC_LMNR_0_add_vars_passPreselection.root', 
          'sub_samples/sample_2018_MC_LMNR_1_add_vars_passPreselection.root',
          'sub_samples/sample_2018_MC_LMNR_2_add_vars_passPreselection.root', 
          'sub_samples/sample_2018_MC_LMNR_3_add_vars_passPreselection.root', 
          'sub_samples/sample_2018_MC_LMNR_4_add_vars_passPreselection.root', 
          'sub_samples/sample_2018_MC_LMNR_5_add_vars_passPreselection.root', 
          'sub_samples/sample_2018_MC_LMNR_6_add_vars_passPreselection.root', 
          'sub_samples/sample_2018_MC_LMNR_7_add_vars_passPreselection.root', 
          'sub_samples/sample_2018_MC_LMNR_8_add_vars_passPreselection.root', 
          'sub_samples/sample_2018_MC_LMNR_9_add_vars_passPreselection.root', 
          'sub_samples/sample_2018_MC_LMNR_10_add_vars_passPreselection.root',
]

bkg_list = [
          'sub_samples/sample_2018_data_LMNR_0_add_vars.root',
          'sub_samples/sample_2018_data_LMNR_1_add_vars.root',
          'sub_samples/sample_2018_data_LMNR_2_add_vars.root',
          'sub_samples/sample_2018_data_LMNR_3_add_vars.root',
          'sub_samples/sample_2018_data_LMNR_4_add_vars.root',
          'sub_samples/sample_2018_data_LMNR_5_add_vars.root',
          'sub_samples/sample_2018_data_LMNR_6_add_vars.root',
          'sub_samples/sample_2018_data_LMNR_7_add_vars.root',
          'sub_samples/sample_2018_data_LMNR_8_add_vars.root',
          'sub_samples/sample_2018_data_LMNR_9_add_vars.root',
          'sub_samples/sample_2018_data_LMNR_10_add_vars.root',
]

import pdb
for isample in range(0,1):

#     tag = '_useSimpleIP_test_%s'%isample
#     tag = '_useMinMaxIP_2018_%s'%isample
#     tag = '_useMaxIso_2018_%s'%isample
    tag = '_noIP2D_2018_%s'%isample
#     tag = '_removekstMass_2018_%s'%isample
#     tag = '_deltakstMass_2018_%s'%isample
...
#     pdb.set_trace()
    ...
    ## data_nan = data[data.isna().any(axis=1)]
#     data_nan_b = data[data['bDCABS/bDCABSE'].isna()]
#     data_nan_l = data[data['bLBS/bLBSE'].isna()]
#     data_nan_w = data[data['weight'].isna()]
    ...
    # {'target': 944.9104820492136, 'params': {'colsample_bytree': 0.9418799902767195, 'learning_rate': 0.09369408000810243, 
    # 'max_depth': 3.348946563695231, 'min_child_weight': 2.579265592717901, 'n_estimators': 411.7743650678679, 'subsample': 0.6044992123630217}}
    ### optimisation w/o trkMinIP
    clf = XGBClassifier(
       colsample_bytree  = 0.942,
        learning_rate    = 0.094,
        min_child_weight = 2.58,
        n_estimators     = 410,
        max_depth        = 3,
        subsample        = 0.604,
